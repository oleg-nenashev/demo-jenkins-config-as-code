...
export GITHUB_USERNAME=${3:-${GITHUB_USERNAME}}
export GITHUB_PASSWORD=${4:-${GITHUB_PASSWORD}}
...
runMvnw() {
 GOALS=${1}
 echo "GOLAS: ${GOALS}"
 echo "MAVEN_PARAMS: ${MAVEN_PARAMS}"
